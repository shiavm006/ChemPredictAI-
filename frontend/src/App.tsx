...
function App() {
  ...
  const commonCompounds = [
    ...
    "sodium hydroxide", "sodium chloride", "calcium carbonate", "ammonia",
    "glucose", "fructose", "sucrose", "methane", "ethane", "propane",
    "butane", "carbon dioxide", "hydrogen peroxide", "formaldehyde",
    "chloroform", "dichloromethane", "ethyl acetate", "diethyl ether",
    "pyridine", "aniline", "phenol", "cyclohexane", "hexane"
  ];
